...
def build_parser(*, prog: str = "python -m nro.qc") -> argparse.ArgumentParser:
    """Build the quality-control dispatcher parser."""
    parser = argparse.ArgumentParser(prog=prog, description=__doc__)
    parser.add_argument("qctype", choices=tuple(QUALITY_CONTROLS), help="Quality-control type")
    return parser


def main(argv: list[str] | None = None, *, prog: str = "python -m nro.qc") -> None:
    """Dispatch a named quality-control type with its remaining arguments."""
