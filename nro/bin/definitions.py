...
def main(argv=None, *, prog='nro definitions'):
    ...
    parser.add_argument('--json', action='store_true', help='Report the path and validation counts as JSON')
    ...
    try:
        ...
        if args.json:
            ...
            if args.action == 'create':
                print('Site selection is unchanged. Use nro paths set definitions=PATH to select this store.')
