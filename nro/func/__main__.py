...
def main(argv: list[str] | None = None) -> None:
    ...
    try:
        ...
        selected = resolve_run(
            discover_raw_runs(Path(BIDS_PATH) / args.project / sub_id), selectors
        )
    ...
    from nro.func.module import main as run_func
    ...
    _run_with_error_logging(run_func, module_argv)
